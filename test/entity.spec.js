        ...
        describe('with creation timestamp', () => {
            before(async () => {
                await helpers
                    ...
                    .withOptions({ creationTimestamp: '2016-01-20', withEntities: true, 'skip-black-format': true })
                    .withArguments(['foo'])
                    .withPrompts({
                        fieldAdd: false,
                        relationshipAdd: false,
        ...
        describe('with wrong base changelog date', () => {
            before(async () => {
                await helpers
                    ...
                    .withOptions({ baseChangelogDate: '20-01-2016', 'skip-black-format': true })
                    .withArguments(['foo'])
                    .withPrompts({
                        fieldAdd: false,
                        relationshipAdd: false,
            ...
            describe('no dto, no service, no pagination', () => {
                before(async () => {
                    await helpers
                        ...
                        .withArguments(['Foo'])
                        .withOptions({ regenerate: true, force: true, 'skip-black-format': true });
                });
            ...
            describe('no dto, no service, no pagination', () => {
                before(async () => {
                    await helpers
                        ...
                        .withOptions({ 'skip-black-format': true })
                        .withArguments(['foo']);
                });
